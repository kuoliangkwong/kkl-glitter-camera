...
public class CameraView extends FrameLayout implements LifecycleObserver {
    ...
    static {
        ...
        workerThread.start();
        sWorkerHandler = new Handler(Looper.getMainLooper());
    }
    ...
    public void setPreviewCallback(Camera.PreviewCallback callback){
        if (mCameraImpl instanceof Camera1) {
            ((Camera1)mCameraImpl).setPreviewCallback(callback);
        }
    }
    ...
    public void stop() {
        ...
        sWorkerHandler.removeCallbacks(mFacingRunnable);
        sWorkerHandler.removeCallbacks(mFlashRunnable);
        mIsStarted = false;
        mCameraImpl.stop();
    }
    ...
    public void setFacing(@Facing final int facing) {
        ...
        sWorkerHandler.removeCallbacks(mFacingRunnable);
        sWorkerHandler.post(mFacingRunnable);
    }
    ...
    public void setFlash(@Flash int flash) {
        ...
        sWorkerHandler.removeCallbacks(mFlashRunnable);
        sWorkerHandler.post(mFlashRunnable);
    }
    ...
    Runnable mFacingRunnable = new Runnable() {
        @Override
        public void run() {
            mCameraImpl.setFacing(mFacing);
        }
    };
